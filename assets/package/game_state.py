# -*- coding: utf-8 -*-
"""Runtime gameplay state (was game_deroulement.py).

Holds the per-session counters and the player-orientation state used by the
movement engine and the renderer.
"""
